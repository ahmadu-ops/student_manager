        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('filieres.index') }}" class="ml-1 text-gray-500 hover:text-primary-600">Filières</a>
                </div>
            </li>
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-gray-700 font-medium">Nouvelle</span>
                </div>
            </li>
        </ol>
    </nav>
            ...
            <form action="{{ route('filieres.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                           ...
                           name="nom" 
                           value="{{ old('nom') }}"
                           class="form-input @error('nom') border-red-500 focus:ring-red-500 @enderror"
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Le nom doit être unique et représenter clairement la filière.
                    </p>
                </div>
